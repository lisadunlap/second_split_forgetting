...
def high_fslt_low_ssft(cfg, first_df, second_df, num_examples):
    """ Paper method: remove the examples with the highest FSLT and lowest SSFT """
    ...
    return results.sort_values('fslt', ascending=False).sort_values('ssft', ascending=True)[:num_examples]
